...
:root {
  ...
  --block-neutral: #fbfbfb;
  --block-blue: #f6f9ff;
  --block-green: #f6fbf8;
  --block-amber: #fffaf2;
  --block-lavender: #faf7ff;
  --block-cyan: #f4fbfb;
  --block-rose: #fff7f7;
}
